...
def buildFeatureStatement(tree):
    ...
    item = core.resolveObjectFOPC(subject)
    ...
    core.findAndAttachPrepObjectsFOPC(root, subject, item)
    ...
    core.findAndAssertFeaturesFOPC(root, item)
    core.findAndAssertDefinitionsFOPC(root, item)
